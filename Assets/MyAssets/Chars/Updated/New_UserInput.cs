...
public class New_UserInput : MonoBehaviour
{

    private CapsuleCollider col;
    public bool walkByDefault = false;
    [SerializeField]
    private New_CharMove character;
    [SerializeField]
    private New_Movement character_aim;
    ...
    void Start()
    {
        ...
        character = GetComponent<New_CharMove>();
        character_aim = GetComponent<New_Movement>();
    ...
    void Update()
    {
        if (Input.GetButtonDown("Jump")) { character_aim.m_Jump = true; }
        ShootHandler();
        WeaponChanger();
        AdditionalInput();
        //HandleCurves();
    ...
    void FixedUpdate()
    {
        ...
        else
        {
            ...
            character_aim.ChangeMovementScript(horizontal, vertical, Vector3.Scale(cam.forward, new Vector3(1, 0, 1)).normalized, cam.right,a_wanttorun);
