...
public class WeaponManager : MonoBehaviour
{
    ...
    public int MaxCarryingWeapons = 4;
    public bool aim;

    public enum WeaponType
    {
        Pistol, Rifle, Sniper, Knife, Grenade, Bomb
    }
    Animator anim;
    ...
    {
        if (ActiveWeapon.weaponType != WeaponType.Bomb && ActiveWeapon.weaponType != WeaponType.Knife)
        {
