...
public class Yo_TPUserControl : MonoBehaviour
{
    ...
    public Yo_Movement m_CharacterAim;
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    private void Start()
    {
        ...
        m_Character = GetComponentInChildren<Yo_TPCharacter>();
        m_CharacterAim = GetComponent<Yo_Movement>();
    ...
    private void FixedUpdate()
    {
        ...
        else
        {
            ...
            //Debug.Log(go.name);
            m_Move = Vector3.zero;
            Vector3 dir = lookPos - go.localPosition;
            dir.y = 0;

            //transform.localRotation = Quaternion.Slerp(transform.localRotation, Quaternion.LookRotation(dir),20* Time.deltaTime);
            //transform.rotation = Quaternion.Slerp(transform.rotation, Quaternion.LookRotation(dir), 20 * Time.deltaTime);
            //transform.rotation = Quaternion.Slerp(transform.rotation, Quaternion.LookRotation(dir), 20 * Time.deltaTime);

            go.localRotation = Quaternion.Slerp(go.localRotation, Quaternion.LookRotation(dir), 20 * Time.deltaTime);
