...
public class Yo_TPCharacter : MonoBehaviour
{
    [SerializeField]
    float m_MovingTurnSpeed = 36;
    [SerializeField]
   ...
   void HandleGroundedMovement(bool crouch, bool jump)
    ...
    void SetUpAnimator()
    {
       ...
       /* foreach (var childAnimator in m_Animator.gameObject.GetComponentsInChildren<Animator>())
        {
    ...
    void TurnTowardsCameraForward()
    {
        if (Mathf.Abs(m_ForwardAmount) < .01f)
        {
            ...
            {
                m_TurnAmount += lookAngle * m_StationaryTurnSpeed * 0.001f;
            }
        }
    }
}
